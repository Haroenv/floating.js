...
(function(root, factory) {
  ...
  function floating(options) {
    ...
    for (var i = 0; i < options.number; i++) {
      ...
      floater.style.cssText = "position: absolute; font-size: 2em; left: 0; bottom: -100%; animation: float "+options.duration+"s ease-in "+i*Math.random()+"s "+options.repeat+" "+options.direction+", move  3s ease-in-out "+i*Math.random()+"s infinite; transform: translateX("+Math.random()*100+"vw);";
